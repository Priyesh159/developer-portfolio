    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-foreground/5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {[
            { year: '2024', title: 'Senior Full-Stack Developer @ TechCorp', description: 'Leading development of customer-facing applications' },
            { year: '2022', title: 'Frontend Developer @ StartupXYZ', description: 'Built responsive web apps with React ecosystem' },
            { year: '2020', title: 'Junior Developer @ CodeAgency', description: 'Learned modern web development practices' },
          ].map((experience) => (
